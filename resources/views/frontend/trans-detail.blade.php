...
<title>Prepaid | Transaction Detail</title>
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="d-flex flex-column align-items-center table-responsive-sm">
                <table class="table border-collapse ">
                    <thead>                    
                        <tr>
                            ...
                            <td><a href="{{route('printable')}}" type="button" class="btn btn-outline-light">Print Receipt</button></td>
                        </tr>                    
                    </thead>
                ...
                <button onclick="back()" type="button" class="btn btn-lg btn-onethird" style="background: #0D9587; color:white">Reoder</button>
            </div>
        </div>
    </div>
    <script>
