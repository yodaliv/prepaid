        ...
        <div class="col-md-8">
            ...
            <div class="" id="electricity" role="tabpanel" aria-labelledby="electricity-tab">
                <form method="get" action="{{ route('order') }}" id="order" name="order">
                    ...
                    <div class="row mb-3 justify-content-center">
                        <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-lx-7">
                            <select class="form-control" name="bundle" id="bundle" required autocomplete="bundle" autofocus >
                                <option value="">Select Data Bundle</option>
                                <option value="1">Bundle1</option>
                                <option value="2">Bundle2</option>
                            </select>
                            @error('bundle')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                    ...
                    <input type="hidden" name="servicetype" value="data">
