<header class="header-contact-bg">
    ...
    <div class="container intro-text">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                @auth
                    <a href="/user" class="btn header-btn-1 px-4 mr-2 montserrat-bold wow animated fadeInUp">user <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    <a href="/payment/mobile" class="btn header-btn-2 montserrat-bold wow animated fadeInUp">Pay now</a>
                @endauth
                @guest
                    <a href="{{ url('register') }}" class="btn header-btn-1 px-4 mr-2 montserrat-bold wow animated fadeInUp">get started <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                    <a href="{{ url('login') }}" class="btn header-btn-2 montserrat-bold wow animated fadeInUp">login</a>
                @endguest
            </div>
        </div>
    </div>
