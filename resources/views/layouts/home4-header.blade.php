                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="description">
                            <h3 class="text-white text-uppercase lg-font-32 sm-font-32 xs-font-32">RESET PASSWORD</h3>
                        </div>
                    ...
                    <div class="col-md-8 col-lg-8 col-xl-8 lg-ml-45px">
                        <div class="justify-content-center loginCheck">
                            <form method="post" action="/" id="loginCheck" name="loginCheck" class="md-pt-20px">
                                ...
                                <div id="res"></div>  
                                <a href="#" style="background: #0F9588; color:white " class="btn px-5 py-3 mt-5px lg-font-24 md-font-24 hvr-grow btn-continue" onclick="submitForm();">Send Rest Link</a>
                            </form>
                        </div>  
                    </div>
                    <div class="col-md-2 col-lg-2 col-xl-2">
                    ...
                    <div class="col-md-8 col-lg-8 col-xl-8 lg-ml-45px">
                        <div class="justify-content-center loginCheck">
                            <form method="post" action="/" id="loginCheck" name="loginCheck" class="md-pt-20px">
                                ...
                                <input type="number" class="form-control lg-font-20 m-h-btn color-black" id="mobile_no" name="mobile" placeholder="Enter Your Phone Number">
                                <div id="res"></div>
